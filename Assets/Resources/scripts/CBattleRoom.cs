...
public class CBattleRoom : MonoBehaviour {
	...
	void Awake()
	{
        ...
        this.quit = Resources.Load("images/title_blue") as Texture;
	...
	void OnGUI()
	{
        ...
        if (GUI.Button(new Rect(20 + (80 * ratio), 10, 80 * ratio, 80 * ratio), this.quit))
        {
            StopAllCoroutines();
            // [6/17/2015 kain0024] 이건 apk 파일로 뽑았을 경우만 작동 됨!!
            Application.Quit();
        }
	}
